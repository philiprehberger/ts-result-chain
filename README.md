...
[![Last updated](https://img.shields.io/github/last-commit/philiprehberger/ts-result-chain)](https://github.com/philiprehberger/ts-result-chain/commits/main)
...
⭐ [Star the repo](https://github.com/philiprehberger/ts-result-chain)

🐛 [Report issues](https://github.com/philiprehberger/ts-result-chain/issues?q=is%3Aissue+is%3Aopen+label%3Abug)

💡 [Suggest features](https://github.com/philiprehberger/ts-result-chain/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
